...
export const STARTER_SKILLS: SkillData[] = [
  ...
  // === 魅惑之吻 ===
  {
    ...
    accuracy: 90,
    critModifier: 5,
    buffs: [{ type: BuffType.ENDURANCE_DOWN, value: -8, isPercent: true, duration: 2, stackable: false }],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
    hitCount: 1,
...
export const CONTROL_SKILLS: SkillData[] = [
  ...
  },
  {
    ...
    effectDescription: '发情5回合，敏感+30%，忍耐-15%',
    icon: 'Flask',
    type: SkillType.CONTROL,
    rarity: SkillRarity.EPIC,
    staminaCost: 20,
    ...
    buffs: [
      ...
      { type: BuffType.ENDURANCE_DOWN, value: -15, isPercent: true, duration: 5, stackable: false },
    ],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
